...
var file_rbac_rbac_proto_goTypes = []any{
...
func file_rbac_rbac_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rbac_rbac_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RBAC); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rbac_rbac_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_rbac_rbac_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Role); i {
			case 0:
				return &v.state
			case 1:
